...
Here is the `segmentize()` function parameterized with some basic settings: a target segment length of 30km, with the maximum allowable gap in effort within segments to be 6 hours. The optional input `seed` is given an integer so that the results are reproducible.  
