...
1.  (*Optional*) Apply a calibration adjustment to the observer's best estimate, as discussed above; if any part of the calibration adjustment process fails, the original estimates are used (observer `ss_valid` is still `TRUE` for the observer-sighting).  
